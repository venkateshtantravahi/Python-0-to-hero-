...
## Sections
- 🐍 [Initializing pipenv](#snake-initializing-pipenv-optional) (optional)
- 📘 [Creating a project](#blue_book-creating-a-project)
- :page_with_curl: [Creating an app](#page_with_curl-creating-an-app)
- 📺 [Creating a view](#tv-creating-a-view)
- 🎨 [Creating a template](#art-creating-a-template)
- 🎫 [Creating a model](#ticket-creating-a-model)
- 📮 [Creating model objects and queries](#postbox-creating-model-objects-and-queries)
- 👨 [Using the Admin page](#man-using-the-admin-page)
